...
export const ContentInputView: React.FC<ContentInputViewProps> = ({
  ...
  const handleQuickAction = (action: string) => {
    if (events.includes("OnQuickAction") && dispatchEvent) {
      dispatchEvent("OnQuickAction", id, [action]);
    }
  };
  ...
  return (
    <div className="civ-shell" style={{ width, height }}>
      ...
      {/* Quick Action Pills */}
      <div className="civ-quick-actions">
        <button onClick={() => handleQuickAction("Write")} className="civ-quick-btn">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            <path d="M12 20h9M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z"/>
          </svg>
          <span>Write</span>
        </button>
        <button onClick={() => handleQuickAction("Learn")} className="civ-quick-btn">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <button onClick={() => handleQuickAction("From Drive")} className="civ-quick-btn">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            <path d="M10 2H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-8L10 2z" />
          </svg>
          <span>From Drive</span>
        </button>
        <button onClick={() => handleQuickAction("From Calendar")} className="civ-quick-btn">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <button onClick={() => handleQuickAction("From Gmail")} className="civ-quick-btn">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
