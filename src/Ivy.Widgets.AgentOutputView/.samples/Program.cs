...
static class SampleData
{
    ...
    [
        ...
        """{"kind":"text","timestamp":"2026-05-22T10:00:04Z","text":"I can see the issue — the middleware doesn't validate the token format. Let me also check the test file.","delta":false}""",
