...
[App(title: "Pre-buffered", icon: Icons.FileText, group: ["AgentOutputView"])]
...
[App(title: "Live Stream", icon: Icons.Radio, group: ["AgentOutputView"])]
...
[App(title: "Error Case", icon: Icons.CircleX, group: ["AgentOutputView"])]
...
[App(title: "Table Output", icon: Icons.Table, group: ["AgentOutputView"])]
...
[App(title: "Process View", icon: Icons.Activity, group: ["TendrilProcessView"])]
