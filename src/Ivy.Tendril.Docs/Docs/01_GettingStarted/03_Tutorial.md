...
The installer downloads and sets up the standalone Tendril application and required dependencies.
...
- See the full [CLI reference](../09_Advanced/01_CLI/00_Overview.md) for power-user workflows
