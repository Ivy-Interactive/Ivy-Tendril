...
This validates your installation, checks required software, and verifies database and agent connectivity. See the [CLI reference](../08_Advanced/01_CLI/_Index.md) for details.
