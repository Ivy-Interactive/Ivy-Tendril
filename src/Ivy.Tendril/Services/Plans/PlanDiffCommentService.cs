...
public class PlanDiffCommentService : IPlanDiffCommentService
{
    private const string CommentsFileName = "draft_diff_comments.yaml";
    private readonly ILogger<PlanDiffCommentService> _logger;

    public event Action<string, List<DraftComment>>? CommentsChanged;

    public PlanDiffCommentService(ILogger<PlanDiffCommentService> logger)
    {
        _logger = logger;
    }
