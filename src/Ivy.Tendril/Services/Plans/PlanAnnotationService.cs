...
public class PlanAnnotationService : IPlanAnnotationService
{
    private readonly ILogger<PlanAnnotationService> _logger;

    public event Action<string, List<MarkdownAnnotation>>? AnnotationsChanged;

    public PlanAnnotationService(ILogger<PlanAnnotationService> logger)
    {
        _logger = logger;
    }
