...
│   │   ├── DotnetTest.md
│   │   └── ...
│   ├── Wireframes/                   # Throwaway UI mockups for UX plans (see Wireframes)
...
- **Wireframes:** `wireframe` fences in a `## Wireframe` section directly under the H1, for plans that add or reshape a screen, page, dialog, panel or tool. See **Wireframes** above.
